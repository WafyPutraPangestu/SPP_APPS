    ...
    <div style="display: flex; flex-direction: column; min-height: 100vh; background: var(--surface);">
        ...
        <main class="content">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="pay-card lg:col-span-2" style="position: relative;">

                    {{-- Status badge di pojok kanan atas --}}
                    <div style="position: absolute; top: 24px; right: 24px; z-index: 3;">
                    ...
                    <div style="position: relative; z-index: 2;">
                        ...
                        <div style="margin-bottom: 28px;">
                            <div class="label-caps" style="color: var(--em-300); margin-bottom: 8px;">Data Siswa</div>
                            <div class="santri-info">
                                <div
                                    style="width: 52px; height: 52px; border-radius: 14px;
                                            background: rgba(16,185,129,0.15); border: 1px solid rgba(16,185,129,0.25);
                                            display: flex; align-items: center; justify-content: center;
                                            font-size: 18px; font-weight: 700; color: var(--em-300);">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 28px;">
                            ...
                            <div>
                                <div class="label-caps" style="color: var(--em-300); margin-bottom: 4px;">Bulan</div>
                                <div
                            ...
                            <div>
                                <div class="label-caps" style="color: var(--em-300); margin-bottom: 4px;">Tahun</div>
                                <div
                                    style="font-family: var(--font-display); font-size: 22px; font-weight: 700;
                                            color: white; letter-spacing: -0.5px;">
                                    {{ $tagihan->tahun }}
                            ...
                            <div>
                                <div class="label-caps" style="color: var(--em-300); margin-bottom: 4px;">Tahun Ajaran
                                </div>
                            ...
                            <div>
                                <div class="label-caps" style="color: var(--em-300); margin-bottom: 4px;">Nominal SPP
                                </div>
                                <div class="amount" style="font-size: 18px; color: var(--gd-300); font-weight: 600;">
                        ...
                        <div style="display: flex; align-items: center; justify-content: space-between;">
                            ...
                            <div style="text-align: right;">
                                <div class="label-caps" style="color: var(--em-300); margin-bottom: 3px;">Dibuat</div>
                            ...
                            <div style="padding-left: 8px;">
                                ...
                                <div style="display: flex; flex-wrap: wrap; gap: 8px;">
                                    @foreach (['QRIS', 'Transfer', 'E-Wallet', 'Kartu Kredit'] as $m)
                                        <span
                                            style="padding: 4px 10px; border-radius: var(--r-pill);
                        ...
                        <table>
                            ...
                            <tbody>
                                @foreach ($tagihan->pembayaran->sortByDesc('created_at') as $p)
                                    ...
                                    <tr>
                                        <td>
                                            <span class="amount" style="font-size: 12px; color: var(--ink-muted);">
                                                {{ $p->order_id }}
                                            </span>
                                        </td>
                                        <td>
